...
require_file "$plans_path" "Missing target rules: $plans_path" "Run ./init-project.sh \"$project_abs\" first."
require_file "$plan_path" "Missing target plan: $plan_path" "Run ./init-project.sh \"$project_abs\" first."
